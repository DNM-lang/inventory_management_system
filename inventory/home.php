...
<head>
	...
	<link rel="stylesheet" href=" LOGIN/srtdash/assets/bootstrap.min.css">
</head>
<body>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                <a href="home.php" aria-expanded="true"><i class="ti-dashboard"></i><span>dashboard</span></a>
                            ...
                            <li>
                                <a href="tables.php" aria-expanded="true"><i class="fa fa-table"></i>
